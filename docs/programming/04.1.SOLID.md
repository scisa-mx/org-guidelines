...
- [Qué es el Principio de Responsabilidad Única (SRP) y por qué deberías usarlo](https://www.youtube.com/watch?v=24GzEwf6-tw)
...
## Referencias en Youtube
- [Open/Closed Principle Code Example](https://www.youtube.com/watch?v=HuK5ikSPwJM)
...
## Referencias en Youtube
- [Principios SOLID: Principio de Sustitución de Liskov LSP](https://www.youtube.com/watch?v=JwtpU_rH1LE&list=PLWYKfSbdsjJjk_kK-fYcjoYF_TS8_kysZ&index=3)
...
## Referencias en Youtube
- [Principios SOLID: Principio de Segregación de Interfaces ISP](https://www.youtube.com/watch?v=4741GhnZmOk&list=PLWYKfSbdsjJjk_kK-fYcjoYF_TS8_kysZ&index=4)
...
- [Principios SOLID: Principio de Inversión de Dependencia DIP](https://www.youtube.com/watch?v=jHZdf5xFZOA&list=PLWYKfSbdsjJjk_kK-fYcjoYF_TS8_kysZ&index=5)
